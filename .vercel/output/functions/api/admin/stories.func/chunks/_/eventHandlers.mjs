import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { I as prefixStorage, J as useStorage, K as useNitroOrigin, L as emojiCache, M as useOgImageRuntimeConfig, h as createError, N as fetchIsland, O as createHeadCore, P as normaliseFontInput, Q as theme, R as withTrailingSlash, n as getQuery, S as handleCacheHeaders, T as setHeaders, U as setHeader, V as hash, W as parseURL, X as setResponseHeader, Y as proxyRequest, Z as sendRedirect, _ as resolveContext, $ as H3Error } from './nitro.mjs';
