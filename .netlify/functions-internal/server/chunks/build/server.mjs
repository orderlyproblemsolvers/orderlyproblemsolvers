...
import { U as parseQuery, c as createError$1, V as joinURL, W as withQuery, X as defu, Y as headSymbol$1, Z as getRequestHeaders, _ as hasProtocol, $ as isScriptProtocol, a0 as useHead$2, a1 as sanitizeStatusCode, J as withTrailingSlash, a2 as withoutTrailingSlash, a3 as getContext, a4 as $fetch, a5 as baseURL, a6 as resolveUnrefHeadInput$1, a7 as createHooks, a8 as executeAsync, a9 as titleCase, aa as toRouteMatcher, ab as createRouter$1, ac as camelCase, O as parseURL, ad as withoutBase, ae as useSeoMeta$1, af as stringifyQuery, ag as withLeadingSlash, ah as withBase } from '../_/nitro.mjs';
...
function initPlugin(nuxtApp) {
  ...
  const templateParamEntry = useHead$1({
...
function setHeadOgImagePrebuilt(input) {
  ...
  useHead$1({ meta }, { tagPriority: "high" });
}
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-white font-sans text-gray-900 flex flex-col" }, _attrs))}><div class="p-8 flex justify-between items-center"><div class="flex items-center gap-2"><div class="w-3 h-3 bg-red-600 rounded-full animate-pulse"></div><span class="text-xs font-mono font-bold uppercase tracking-widest text-red-600">System Error</span></div><span class="text-xs font-mono font-bold text-gray-300">ERR_CODE_${ssrInterpolate(__props.error?.statusCode)}</span></div><div class="flex-1 flex flex-col items-center justify-center px-4 text-center"><div class="relative mb-8"><h1 class="text-[12rem] md:text-[16rem] font-black leading-none text-gray-50 select-none">${ssrInterpolate(__props.error?.statusCode)}</h1><div class="absolute inset-0 flex items-center justify-center w-max"><div class="bg-white px-6 py-4 border border-gray-200 rounded-xl shadow-xl"><svg class="w-12 h-12 text-gray-400 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg><p class="font-bold text-lg">Data Not Found</p></div></div></div><h2 class="text-3xl md:text-4xl font-black tracking-tight mb-4"> This page is not in the Index. </h2><p class="text-gray-500 max-w-md mx-auto mb-12 text-lg"> The URL you requested does not exist in our directory or has been moved to a different sector. </p><div class="flex flex-col sm:flex-row gap-4"><button class="px-8 py-4 bg-black text-white font-bold rounded-xl hover:bg-gray-800 transition-colors"> Return Home </button>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/search",
        class: "px-8 py-4 border border-gray-200 font-bold rounded-xl hover:border-black transition-colors"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`</div></div><div class="p-8 text-center"><p class="text-[10px] font-mono text-gray-300 uppercase tracking-[0.2em]">Orderly Problem Solvers</p></div></div>`);
    };
  }
});
